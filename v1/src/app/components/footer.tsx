      ...
      <div className={"m-[-5px] pb-16"}>
          ...
          <div className={"flex  items-center gap-10"}>
              <div className={"w-[40%] flex flex-col ml-10"}>
                  ...
                  <h3 className={"text-lg font-bold text-black ml-6"}>{"Merci d'avoir étudié mon portfolio, j'espère que votre expèrience s'est déroulé de manère agréable et bénéfique. Pour toute information supplémentaire n'hésitez pas à me contacter par mail ou via mes réseaux sociaux."}</h3>
              </div>
